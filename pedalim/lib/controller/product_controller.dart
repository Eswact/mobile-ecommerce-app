...
import 'package:pedalim/service/remote_service/remote_product.dart';
...
class ProductController extends GetxController{
  ...
  void getProductByCategory({required String name}) async {
    try {
      isProductLoading(true);
      var result = await RemoteProductService().getByCategory(name: name);
      if(result != null){
        productList.assignAll(productListFromJson(result.body));
      }
    } finally {
